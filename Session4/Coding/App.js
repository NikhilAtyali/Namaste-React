...
//body renders all the restaurant cards
const Body = () => {
  return (
...
const burgerKingn = {
  name: "BurgerKing",
  image:
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQz7xHoi0YdgqJF6qaffpALRwGtD1svbgCQoQ&usqp=CAU",
  cousines: ["Burgers", "Wraps"],
  rating: "4.5",
};
